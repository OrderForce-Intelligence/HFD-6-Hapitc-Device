...
const char* HFDVisualModel::visualNodeNames[NVISUALNODE] =
{
    "stylus",
    "joint_2",
    "joint_1",
...
const char* HFDVisualModel::visualNodeFiles[NVISUALNODE] =
{
    "mesh/stylusO.obj",
...
void HFDVisualModel::initDisplay(sofa::simulation::Node::SPtr node, const std::string& _deviceName, double _scale)
{
    ...
    m_omniVisualNode = node->createChild("HFDVisualModel " + _deviceName);
...
void HFDVisualModel::activateDisplay(bool value)
{ 
...
void HFDVisualModel::updateDisplay(const HFDDriver::Coord& posDevice, HFDDriver::SHDdouble angle1[3], HFDDriver::SHDdouble angle2[3])
{
...
void HFDVisualModel::drawDevice(bool button1Status, bool button2Status)
{

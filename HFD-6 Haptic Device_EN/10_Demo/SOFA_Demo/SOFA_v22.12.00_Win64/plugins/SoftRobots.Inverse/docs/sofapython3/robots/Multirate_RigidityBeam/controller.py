...
#<!--<RequiredPlugin name="HapticSoftRobots"  printLog="1"  />-->
...
def createScene(rootNode):
    ...
    lowRate.addObject('AsynchroLowRateAnimationLoop', name='ALRAL', proxyHighRateObjectNode='GoalProxy', lowRateObjectNode='Beam', printLog=printALRAL)
    ...
    highRate.addObject('AsynchroHighRateAnimationLoop', name='AHRAL', highRateObjectNode='Goal')
    ...
    controlledPoints = Beam.addChild('Beam')
    ...
    #controlledPoints.addObject('Actuator', index="0", effectorGoal="@Pilot/Goal/GoalCollision/GoalCollisionMO.position",  actuator=0)
    controlledPoints.addObject('QPInverseProblemSolver', indices=0, effectorGoal="@/Goal/GoalCollision/GoalCollisionMO.position",  numActuators=2, actuatorMax="1e3 1e3", actuatorMin="-1e3 -1e3 ",actuatorValues="0 0")
    controlledPoints.addObject('CableActuator', index=5, actuator=1, pullPoint="0.30 0.0 0", dir="1 0 0", maxPositiveDisp=0.25, maxNegativeDisp=0.25, maxForce=1e99, isUnilateral=1, interactiveControl=1)
    ...
    #<InteractiveControl name="Network Interactive Control Mot A" address="169.254.8.220" motorIndex="0" mode="3" setpoint="@cable0.setpoint" /> -->

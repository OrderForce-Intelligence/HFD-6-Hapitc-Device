...
******************************************************************************/
#ifndef SOFA_COMPONENT_CONSTRAINTSET_QPINVERSEPROBLEM_H
#define SOFA_COMPONENT_CONSTRAINTSET_QPINVERSEPROBLEM_H
...
class SOFA_SOFTROBOTS_INVERSE_API QPInverseProblem : public constraint::lagrangian::solver::ConstraintProblem
{
...
protected:
    ...
    void storeResults(const type::vector<double> &x);
    void sendResults();
...
using _qpinverseproblem_::QPInverseProblem;

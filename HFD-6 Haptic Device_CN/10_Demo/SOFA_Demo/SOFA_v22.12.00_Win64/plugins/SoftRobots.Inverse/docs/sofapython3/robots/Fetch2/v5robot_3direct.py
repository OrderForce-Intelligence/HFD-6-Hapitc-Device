...
def createScene(rootNode):
    ...
    rootNode.addObject('GenericConstraintSolver', printLog='1', tolerance='1.0e-7', maxIterations='500')
    ...
    rootNode.addObject('PythonScriptController', classname="controller", filename="ArduinoInterfaceDirect.py");
    ...
    MappedCavity11Node.addObject('SurfacePressureConstraint', template='Vec3', triangles='@cavityMesh.triangles', maxPressure=str(dt*500), minPressure='0', visualization='1', maxVolumeGrowth='100000',  maxVolumeGrowthVariation='10000')
    ...
    MappedCavity12Node.addObject('SurfacePressureConstraint', template='Vec3', triangles='@cavityMesh.triangles', maxPressure=str(dt*500), minPressure='0', visualization='1', maxVolumeGrowth='100000',  maxVolumeGrowthVariation='10000')
    ...
    MappedCavity13Node.addObject('SurfacePressureConstraint', template='Vec3', triangles='@cavityMesh.triangles', maxPressure=str(dt*500), minPressure='0', visualization='1', maxVolumeGrowth='100000',  maxVolumeGrowthVariation='10000')
    ...
    MappedCavity21Node.addObject('SurfacePressureConstraint', template='Vec3', triangles='@cavityMesh.triangles', maxPressure=str(dt*500), minPressure='0', visualization='1', maxVolumeGrowth='100000',  maxVolumeGrowthVariation='10000')
    ...
    MappedCavity22Node.addObject('SurfacePressureConstraint', template='Vec3', triangles='@cavityMesh.triangles', maxPressure=str(dt*500), minPressure='0', visualization='1', maxVolumeGrowth='100000',  maxVolumeGrowthVariation='10000')
    ...
    MappedCavity23Node.addObject('SurfacePressureConstraint', template='Vec3', triangles='@cavityMesh.triangles', maxPressure=str(dt*500), minPressure='0', visualization='1', maxVolumeGrowth='100000',  maxVolumeGrowthVariation='10000')
    ...
    MappedCavity31Node.addObject('SurfacePressureConstraint', template='Vec3', triangles='@cavityMesh.triangles', maxPressure=str(dt*500), minPressure='0', visualization='1', maxVolumeGrowth='100000',  maxVolumeGrowthVariation='10000')
    ...
    MappedCavity32Node.addObject('SurfacePressureConstraint', template='Vec3', triangles='@cavityMesh.triangles', maxPressure=str(dt*500), minPressure='0', visualization='1', maxVolumeGrowth='100000',  maxVolumeGrowthVariation='10000')
    ...
    MappedCavity33Node.addObject('SurfacePressureConstraint', template='Vec3', triangles='@cavityMesh.triangles', maxPressure=str(dt*500), minPressure='0', visualization='1', maxVolumeGrowth='100000',  maxVolumeGrowthVariation='10000')
    ...
    MappedCables.addObject('CableConstraint', template="Vec3", name="c1" , indices="0", pullPoint=str(px1)+' 0 '+str(pz1) , maxPositiveDisp="10", maxNegativeDisp="0")
    MappedCables.addObject('CableConstraint', template="Vec3", name="c2" , indices="1", pullPoint=str(px2)+' 0 '+str(pz2) , maxPositiveDisp="10", maxNegativeDisp="0")
    MappedCables.addObject('CableConstraint', template="Vec3", name="c3" , indices="2", pullPoint=str(px3)+' 0 '+str(pz3) , maxPositiveDisp="10", maxNegativeDisp="0")
    MappedCables.addObject('CableConstraint', template="Vec3", name="c4" , indices="0 3", pullPoint=str(px1)+' 0 '+str(pz1) , maxPositiveDisp="20", maxNegativeDisp="0")
    MappedCables.addObject('CableConstraint', template="Vec3", name="c5" , indices="1 4", pullPoint=str(px2)+' 0 '+str(pz2) , maxPositiveDisp="20", maxNegativeDisp="0")
    MappedCables.addObject('CableConstraint', template="Vec3", name="c6" , indices="2 5", pullPoint=str(px3)+' 0 '+str(pz3) , maxPositiveDisp="20", maxNegativeDisp="0")
    MappedCables.addObject('CableConstraint', template="Vec3", name="c7" , indices="0 3 6", pullPoint=str(px1)+' 0 '+str(pz1) , maxPositiveDisp="30", maxNegativeDisp="0")
    MappedCables.addObject('CableConstraint', template="Vec3", name="c8" , indices="1 4 7", pullPoint=str(px2)+' 0 '+str(pz2) , maxPositiveDisp="30", maxNegativeDisp="0")
    MappedCables.addObject('CableConstraint', template="Vec3", name="c9" , indices="2 5 8", pullPoint=str(px3)+' 0 '+str(pz3) , maxPositiveDisp="30", maxNegativeDisp="0")

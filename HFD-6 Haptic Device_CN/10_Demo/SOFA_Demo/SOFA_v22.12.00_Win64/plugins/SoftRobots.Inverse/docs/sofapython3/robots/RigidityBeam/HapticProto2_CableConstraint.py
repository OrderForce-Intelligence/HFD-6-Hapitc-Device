...
def createScene(rootNode):
    ...
    ControlNode.addObject('CableConstraint', name="cable0", indices="1", pullPoint="0 -0.05 0", valueType="force", value='0.20')
    ControlNode.addObject('CableConstraint', name="cable1", indices="2", pullPoint="0.121 -0.05 0", valueType="force", value='0.20')

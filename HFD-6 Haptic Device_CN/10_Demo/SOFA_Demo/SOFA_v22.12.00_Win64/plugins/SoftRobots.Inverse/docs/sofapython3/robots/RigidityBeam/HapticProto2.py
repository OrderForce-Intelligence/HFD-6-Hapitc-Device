...
def createScene(rootNode):
    ...
    GoalNode.addObject('MechanicalObject', name="goalMO", position="0.0605 0.055 0.0")
    ...
    ControlNode.addObject('CableActuator', name="cable0", indices="1", pullPoint="0 -0.05 0", maxPositiveDisp="0.01", minForce="0")
    ControlNode.addObject('CableActuator', name="cable1", indices="2", pullPoint="0.121 -0.05 0", maxPositiveDisp="0.01", minForce="0")
